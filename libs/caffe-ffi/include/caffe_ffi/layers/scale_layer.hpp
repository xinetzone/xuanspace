#ifndef CAFFE_FFI_LAYERS_SCALE_LAYER_HPP_
#define CAFFE_FFI_LAYERS_SCALE_LAYER_HPP_
...
class ScaleLayer : public Layer {
 public:
  ...
  explicit ScaleLayer(const caffe::LayerParameter& param) : Layer(param) {}
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("caffe_ffi.ScaleLayer", ScaleLayer, Layer);
...
#endif  // CAFFE_FFI_LAYERS_SCALE_LAYER_HPP_
