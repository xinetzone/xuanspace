...
function(caffe_ffi_configure_target target_name)
  ...
  if(CAFFE_FFI_ENABLE_PERF_LOG)
    target_compile_definitions(${target_name} ${ARG_VISIBILITY} CAFFE_FFI_ENABLE_PERF_LOG)
    string(APPEND _compile_defs_log "; CAFFE_FFI_ENABLE_PERF_LOG")
  endif()
