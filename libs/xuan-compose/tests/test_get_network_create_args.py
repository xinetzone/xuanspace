...
"""逐用例移植自上游 tests/unit/test_get_network_create_args.py（11 例，断言零削弱）。

适配点：``podman_compose.get_network_create_args`` →
``xuan_compose.translate.networks.get_network_create_args``。
"""

import unittest
from typing import Any

from xuan_compose.translate.networks import get_network_create_args
