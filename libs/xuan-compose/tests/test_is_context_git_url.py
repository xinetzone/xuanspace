...
"""逐用例移植自上游 tests/unit/test_is_context_git_url.py（68 例，断言零削弱）。

适配点：实现位于基础层 :mod:`xuan_compose.normalize`，T5 翻译层
:mod:`xuan_compose.translate.build` 按蓝图符号面再导出，故从此处导入。
"""
...
from xuan_compose.translate.build import is_context_git_url
